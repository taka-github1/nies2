import{t as a}from"./NestedMap-1b5db22e.js";import{m as h}from"./ProgramTemplate-a52cf5ca.js";let p=class{constructor(e){this._rctx=e,this._store=new a}dispose(){this._store.forEach(e=>e.forEach(t=>t.dispose())),this._store.clear()}acquire(e,t,o,r){const n=this._store.get(e,t);if(n!=null)return n.ref(),n;const s=new h(this._rctx,e,t,o,r);return s.ref(),this._store.set(e,t,s),s}get test(){let e=0;return this._store.forEach(t=>t.forEach(o=>e+=o.hasGLName?2:1)),{cachedWebGLObjects:e}}};function l(i){const{options:e,value:t}=i;return typeof e[t]=="number"}function m(i){let e="";for(const t in i){const o=i[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
